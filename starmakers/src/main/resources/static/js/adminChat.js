  ...
  function renderMessages(messages) {
    ...
    messages.forEach(function (message) {
      ...
      if (message.code === "toAdmin") {
        ...
        messageInfo.append(
          $('<span class="direct-chat-name float-right"></span>').text("User")
        );
        ...
        messageInfo.append(
          $('<span class="direct-chat-name float-left"></span>').text("Admin")
        );
        messageElement.append(
          $(
  ...
  $("#messageForm").submit(function (event) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        newMessageInfo.append(
          $('<span class="direct-chat-name float-right"></span>').text("User")
        );
        newMessageInfo.append(
          $('<span class="direct-chat-timestamp float-right"></span>').text(
        ...
        newMessage.append(
          $('<div class="direct-chat-text"></div>').text(formData.content)
        );
